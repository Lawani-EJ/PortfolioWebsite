...
const page = () => {
  const items = [
    ...
    { hobby: "creating Cool Projects 👷🏿‍♂️" },
  ];
      ...
      <div className="flex flex-col gap-3">
        ...
        <FramerWrapper y={0} x={100} >
          <p className=" font-poppins text-xl w-full text-primary max-sm:text-lg">
            I am a Full Stack Web Developer from Abuja F.C.T, Nigeria.
            I love crafting cool web projects and also open-source
            contribuitions. As a student from Babcock University
            I've built a foundational understanding of HTML, CSS, and JavaScript.
            With a keen eye for detail and a commitment to delivery
